...
export const LEVELS = [
  ...
  { id:'L1',  world:W1, name:'GENESIS',       theme:'Pure Chrome Dino tribute', modes:['cube'],
    length:60, speed:1.0,
    palette:['#ffffff','#dddddd','#bbbbbb','#888888'],
    obstacles:['tallCactus','shortCactus','cactusCluster','pterodactyl'],
    unlockReq:null,
