...
export const UPGRADES = [
  { id:'shieldDur',   name:'Shield Duration',   icon:'🛡️', desc:'Shield lasts longer; T1 grants start-of-run shield',
    tiers:[ {dp:50, c:500}, {dp:150, c:1500}, {dp:400, c:5000} ] },
  ...
  { id:'slowDur',     name:'Slow-Mo Duration',  icon:'⏱️', desc:'+1/+2/+3s per tier',
    tiers:[ {dp:40, c:400}, {dp:100, c:1200}, {dp:250, c:3500} ] },
  { id:'scoreMul',    name:'Score Multiplier',  icon:'✨', desc:'+2/5/10% baseline score',
    tiers:[ {dp:80, c:800}, {dp:200, c:2500}, {dp:500, c:7500} ] },
  { id:'coinValue',   name:'Coin Value',        icon:'◎', desc:'+10/25/50% per coin',
    tiers:[ {dp:60, c:500}, {dp:150, c:1500}, {dp:350, c:4500} ] },
  { id:'luckyDrops',  name:'Lucky Drops',       icon:'🎲', desc:'+10/25/50% power-up spawn rate',
    tiers:[ {dp:50, c:500}, {dp:125, c:1500}, {dp:300, c:4000} ] },
  { id:'jumpPower',   name:'Jump Power',        icon:'⬆️', desc:'+5/10/15% cube jump height',
    tiers:[ {dp:75, c:750}, {dp:175, c:2000}, {dp:400, c:5000} ] },
  { id:'reviveFreq',  name:'Revive Frequency',  icon:'❤️', desc:'1 free revive every 5/3/1 runs',
    tiers:[ {dp:100, c:1000}, {dp:250, c:3000}, {dp:600, c:8000} ] }
];

export const CONSUMABLES = [
  { id:'reviveToken',  name:'Revive Token',      icon:'❤️', desc:'One free continue from death (stack 5)',  cost:200,  max:5 },
  { id:'headStart',    name:'Head Start',        icon:'🚀', desc:'Start next run at 2000 score',           cost:500 },
  { id:'mysteryCharge',name:'Mystery Box Charge',icon:'💎', desc:'Guaranteed mystery box next run',         cost:300 },
  { id:'powerPack',    name:'Power-Up Pack',     icon:'⭐', desc:'Guaranteed 3 power-ups next run',         cost:400 },
  { id:'scoreBoost',   name:'Score Boost',       icon:'✨', desc:'5x multiplier first 30s of next run',     cost:1000 },
  { id:'practicePass', name:'Practice Pass 24h', icon:'🎯', desc:'Unlimited practice for 24h',             cost:100 }
];

export const SKINS = [
  { id:'classic',      name:'Classic Dino', desc:'Default skin', cost:0, defaultOwned:true, color:'#00f0ff' },
  { id:'neonCube',     name:'Neon Cube',    desc:'Earned by Portal Master OR 500 DP', dp:500, achievement:'portalMaster', color:'#39ff14' },
  { id:'pixelBird',    name:'Pixel Bird',   desc:'Earned by Treasure Hunter OR 750 DP', dp:750, achievement:'treasureHunter', color:'#ffe600' },
  { id:'glowCat',      name:'Glow Cat',     desc:'Earned by Score 10K OR 1000 DP', dp:1000, achievement:'score10k', color:'#ff2dd4' },
  { id:'robotSkull',   name:'Robot Skull',  desc:'Earned by Score 50K OR 2000 DP', dp:2000, achievement:'score50k', color:'#cccccc' },
  { id:'crystal',      name:'Crystal',      desc:'Earned by Dedicated OR 1500 DP', dp:1500, achievement:'dedicated', color:'#a0e7ff' },
  { id:'firePhoenix',  name:'Fire Phoenix', desc:'Shop only', dp:3000, color:'#ff5b1f' },
  { id:'galaxy',       name:'Galaxy',       desc:'Shop only', dp:5000, color:'#b300ff' },
  { id:'glitch',       name:'Glitch',       desc:'Complete World 3 OR 10000 DP', dp:10000, world3:true, color:'#ff3344' },
  { id:'rainbowDino',  name:'Rainbow Dino', desc:'Konami only', konami:true, color:'rainbow' }
];

export const TRAILS = [
  { id:'dots',     name:'Dots',         cost:0, defaultOwned:true },
  { id:'line',     name:'Solid Line',   cost:500 },
  { id:'rainbow',  name:'Rainbow',      cost:1500 },
  { id:'sparkle',  name:'Sparkles',     cost:2500 },
